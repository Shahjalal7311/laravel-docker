...
-docker images [check docker images]
	...
	## Database magration using docker
	*docker-compose exec [name of container] <your laravel command>*
	...
	## Login to your database server using console
	-docker-compose exec db bash [ in here db means your database service name]
		- mysql -u root -p
